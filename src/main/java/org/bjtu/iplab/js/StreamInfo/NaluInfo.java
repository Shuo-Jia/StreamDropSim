...
public class NaluInfo {
    ...
    public int length_with_start;                 //! Length of the NAL unit (Excluding the start code, which does not belong to the NALU)
    ...
    public transient byte[] startload;
    public transient byte[] payload;
    public transient byte[] allDataload;
